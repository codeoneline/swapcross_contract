...
const swapAndCrossAbi = [
  ...
  'function updateApproveProxy(address newProxy) external',
]
...
const sendSwapAndCross = async (fromTokenSymbol, toTokenSymbol, fromChainSymbol, toChainSymbol, tokenPairId, amount, SwapAndCrossAddress, isTestnet = false) => {
    ...
    const crossParams = {
      smgID: "0x000000000000000000000000000000000000000000000041726965735f303634",
...
setTimeout(async () => {
  ...
  await sendSwapAndCross('USDC', 'USDT', 'ETH', 'AVAX', 232, 3, "0x0E0fC3Fa527C03A43EfC8493C5de876ED3A80d3A")
