...
module.exports = buildModule("SwapAndCrossUUPSModule", (m) => {
  ...
  // 1. 部署实现合约
  const swapAndCrossV1Impl = m.contract("SwapAndCrossV1", [], {id: "SwapAndCrossV1_Implementation"});
  ...
  // 3. 返回代理地址（用户通过代理交互）
  const swapAndCrossV1Proxy = m.contractAt("SwapAndCrossV1", proxy, {id: "SwapAndCrossV1_Proxy"});
